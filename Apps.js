	...
	<head>
		...
		<style>
			...
			.invoice-box table tr td:nth-child(2) {
				text-aliconsole.log('Pressed'gn: right;
			}
			...
			.invoice-box table tr.detailsve
			...
			@media only screen and (max-width: 600px) {
				.invoice-box table tr.top table td {
					width: 100%;
					import FileViewer from 'react-native-file-viewer';
import { Alert } from 'react-native';text-align: center;
				}
		...
		</style>import { FontAwesomeIcon } from '@fortawesome/react-native-fontawesome';
